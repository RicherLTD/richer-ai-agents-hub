-- 0037_conversation_manual_mode.sql
--
...
--
-- NOTE: these columns already exist in production (added by an earlier
-- branch whose migration file was lost in a rebase that reset main; the
-- generated types in src/types/database.ts still reference them). This
-- migration is idempotent (ADD COLUMN IF NOT EXISTS) so re-applying it to
-- production is a no-op, and a fresh database gets the columns.
--
